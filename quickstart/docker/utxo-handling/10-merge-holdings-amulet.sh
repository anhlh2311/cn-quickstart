...
# and uses ExternalPartyAmuletRules (TransferFactory interface) to perform a self-transfer merge.
#
...
interactive_submit() {
  ...
  for attempt in 1 2 3; do
    ...
    jq -n \
      --arg userId "$user_id" \
      --arg submissionId "merge-amulet-${cmd_id}" \
